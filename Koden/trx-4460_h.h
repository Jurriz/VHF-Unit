...
// ======================================================================================================================
const rom struct MyNewRad Beacon151Rad[] = {
...
{0x06, 0x11, 0x20, 0x02, 0x54, 0x0A, 0x07},
...
#else
	{0x08, 0x11, 0x22, 0x04, 0x00, 0x18, 0x1F, 0xC0, 0x1D},							// 23	PA_PWR, här 0x1F men max är 0x4F, 8V
#endif
...
// 31 = Slår av matningsspänningen till antenn-switchen
// 32 = Byte state till READY
...
{0x06, 0x11, 0x20, 0x02, 0x54, 0x08, 0x07},
{0x05, 0x11, 0x20, 0x01, 0x57, 0x00},
