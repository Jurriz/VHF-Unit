...
% Abbreviations and glossary - ,toc,section=section -section=chapter - ,acronym -, numberedsection=autolabel,,acronym ,toc {}
\usepackage[automake,acronym,section=chapter]{glossaries-extra}
\makeglossaries
...
%% Putting in the glossaries before the dokument
\input{glossary.tex}
\begin{document}
